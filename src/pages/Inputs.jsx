...
function Inputs() {
    ...
    async function fetchData() {
      try {
        const assetResponse = await axios.get(
          `http://bisbudyy.xyz:8080/api/erp/assets/${userName}`,
          config
        );
  ...
  const handleCustomer = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://bisbudyy.xyz:8080/api/erp/customer/add",
        customerDetail,
        config
      );
  ...
  const handleEmployee = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://bisbudyy.xyz:8080/api/erp/employee/add",
        empDetail,
        config
      );
  ...
  const handleLoan = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://bisbudyy.xyz:8080/api/erp/loan/add",
        loanDetail,
        config
      );
      // do something with response
  ...
  const handleRent = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://bisbudyy.xyz:8080/api/erp/rent/add",
        rentDetail,
        config
      );
  ...
  const handleOD = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://bisbudyy.xyz:8080/api/erp/OD/add",
        odDetail,
        config
      );
      // do something with response
  ...
  const handleCompanyInfo = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://bisbudyy.xyz:8080/api/erp/company/save",
        companyDetail,
        config
      );
      // do something with response
  ...
  const handleAsset = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://bisbudyy.xyz:8080/api/erp/asset/save",
        assetDetail,
        config
      );
  ...
  const handleEditedValue = async (e, colName, value) => {
    ...
    try {
      await axios.put(
        `http://bisbudyy.xyz:8080/api/erp/asset/edit/${colName}/${value}/${userName}`,
        null,
        config
      );
    } catch (error) {
  ...
  const handleCompanyEdit = async (e, colName, name, address, zip, phone_Number, gst_Number) => {
    ...
    try {
      await axios.put(
        `http://bisbudyy.xyz:8080/api/erp/company/edit/${colName}/${userName}?name=${name}&address=${address}&zip=${zip}&phone=${phone_Number}&gstN=${gst_Number}`,
        null,
        config
      );
    } catch (error) {
