...
function Expenses() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://bisbudyy.xyz:8080/api/erp/employees/${userName}`, config)
      .then((response) => {
    ...
    axios
      .get(`http://bisbudyy.xyz:8080/api/erp/loans/${userName}`, config)
      .then((response) => {
    ...
    // fetch the list of employees and set the state
    axios
      .get(`http://bisbudyy.xyz:8080/api/erp/rent/${userName}`, config)
      .then((response) => {
  ...
  const handleEmployeeChange = async (event) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://bisbudyy.xyz:8080/api/erp/employeeById/${selectedEmployeeIdTemp}`,
        config
      );
  ...
  const handleLoanChange = async (event) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://bisbudyy.xyz:8080/api/erp/loanById/${selectedLoanIdTemp}`,
        config
      );
  ...
  const handleRentChange = async (event) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://bisbudyy.xyz:8080/api/erp/rentById/${selectedRentIdTemp}`,
        config
      );
  ...
  const handleSalary = async (event) => {
    ...
    await axios
      .post(
        "http://bisbudyy.xyz:8080/api/erp/salaryPayment/save",
        data,
        configForPut
      )
      .then((response) => {
  ...
  const handleLoan = async (event) => {
    ...
    await axios
      .post(
        "http://bisbudyy.xyz:8080/api/erp/loanPayment/save",
        dataForLoan,
        configForPut
      )
      .then((response) => {
  ...
  const handleRent = async (event) => {
    ...
    await axios
      .post(
        "http://bisbudyy.xyz:8080/api/erp/rentPayment/save",
        dataForRent,
        configForPut
      )
      .then((response) => {
  ...
  const handleOtherExpenses = async (event) => {
    ...
    await axios
      .post(
        "http://bisbudyy.xyz:8080/api/erp/monthlyIncomeExpense/save",
  ...
  const handleOD = async (event) => {
    ...
    await axios
      .post(
        "http://bisbudyy.xyz:8080/api/erp/overDraftPayment/save",
        dataForOD,
        configForPut
      )
      .then((response) => {
  ...
  const handleCapitalDraw = async (event) => {
    ...
    await axios
      .put(
        `http://bisbudyy.xyz:8080/api/erp/capitalDraw/${capitalDrawings}/${userName}`,
        configForPut
      )
      .then((response) => {
        console.log(response.data);
  ...
  const handleTAC = async (event) => {
    ...
    try {
      const response = await axios.put(
        `http://bisbudyy.xyz:8080/api/erp/tAC/generate/${currentYear}`,
        null,
        configForPut
      );
      console.log(response.data);
  ...
  const handlePandL = async (event) => {
    ...
    try {
      const response = await axios.put(
        `http://bisbudyy.xyz:8080/api/erp/pAndL/generate/${currentYear}`,
        null,
        configForPut
      );
      console.log(response.data);
  ...
  const handleBalanceSheet = async (event) => {
    ...
    try {
      const response = await axios.put(
        `http://bisbudyy.xyz:8080/api/erp/balanceSheet/generate/${currentYear}`,
        null,
        configForPut
      );
      console.log(response.data);
